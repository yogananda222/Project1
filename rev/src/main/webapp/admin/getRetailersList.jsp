    ...
    <tbody>
        <c:forEach var="retailer" items="${retailersList}">
            <tr>
                ...
                <td>
                    <a href="deleteRetailerRequest?retailerId=${retailer.retailerId}" onclick="return confirm('Are you sure you want to delete this retailer request?');">Delete</a>
                    |
                    <a href="approveRetailerRequest?retailerId=${retailer.retailerId}" onclick="return confirm('Are you sure you want to approve this retailer request?');">Approve</a>
                </td>
            </tr>
        </c:forEach>
    </tbody>
