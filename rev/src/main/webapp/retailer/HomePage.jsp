...
<body>
    ...
    <main class="container mt-4">
        <div class="welcome-message">
            <h2>Welcome, <span id="retailer-name"><%= (session.getAttribute("retailer") != null ? ((Retailer)session.getAttribute("retailer")).getBusinessName() : "Guest") %></span></h2>
            <p>Explore the options below to manage your products and orders.</p>
        </div>
    </main>
